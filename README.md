About pyxb-feedstock
====================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pyxb-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/pabigot/pyxb
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=5367&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pyxb-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pyxb` can be installed with `conda`:
...
It is possible to list all of the versions of `pyxb` available on your platform with `conda`:
...
```
mamba search pyxb --channel conda-forge
```
...
mamba repoquery search pyxb --channel conda-forge

# List packages depending on `pyxb`:
mamba repoquery whoneeds pyxb --channel conda-forge

# List dependencies of `pyxb`:
mamba repoquery depends pyxb --channel conda-forge
```
